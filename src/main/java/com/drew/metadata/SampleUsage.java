...
public class SampleUsage
{
    ...
    public static void main(String[] args)
    {
        ...
        File file = new File(classLoader.getResource("withIptcExifGps.jpg").getFile());
        ...
        try {
            ...
            HashMap<FileType, List<String>> mapaMetadata = ImageMetadataReader.readMetadataListFileType();
            ...
            for(Directory directory : metadata.getDirectories()){
                if(directory.containsTag(ExifSubIFDDirectory.TAG_DATETIME_ORIGINAL)){
                    System.out.println(
                            directory.getTagName(ExifSubIFDDirectory.TAG_DATETIME_ORIGINAL) + "\t" +
                                    directory.getDescription(ExifSubIFDDirectory.TAG_DATETIME_ORIGINAL)
                    );
                }
            }
            //print(metadata);
